...
from file_helpers import get_lines
...
def main() -> None:
	file_input = get_lines(2)
	print(f'Part 1 = {sum(get_invalid(get_ranges(file_input)))}')
	print(f'Part 2 = {sum(get_invalid_arbitrary(get_ranges(file_input)))}')
